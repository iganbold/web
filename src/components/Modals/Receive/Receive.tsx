  ...
  const ConnectAWallet = () => (
    <>
      <ModalBody alignItems='center' justifyContent='center'>
        <Text
          translation={['modals.receive.connectAWallet', { symbol: symbol.toUpperCase() }]}
          color='gray.500'
          textAlign='center'
        />
      </ModalBody>
  ...
  const WalletConnected = () => (
    <>
      ...
      <ModalFooter flexDir='column'>
        <Box>
          <Text
            translation={['modals.receive.onlySend', { asset: name, symbol: symbol.toUpperCase() }]}
            color='gray.500'
            textAlign='center'
          />
        </Box>
  ...
  return (
    <Modal isOpen={isOpen} onClose={() => close()} isCentered>
      ...
      <ModalContent>
        ...
        <ModalCloseButton />
        {state.wallet ? <WalletConnected /> : <ConnectAWallet />}
      </ModalContent>
    </Modal>
  )
}
